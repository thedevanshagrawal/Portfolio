      ...
      <main>
        <section className="firstSection" id="home">
          <div className="left-section">
            <div>
              Hi, my name is <span className="purple">Pratiksha</span>
            </div>
          ...
          <div className="Education">
            <div className="education-box">
              <div className="education-title">
                ❖ BCA | The ICFAI University, Raipur
              </div>
              <div className="education-desc">7.69 | (Aug ’22 – Present)</div>
            </div>
            <div className="education-box">
              <div className="education-title">
                ❖ XII (CBSE) | Kendriya Vidyalaya No.1, Raipur
              </div>
              <div className="education-desc">88.8% | 2022</div>
            </div>
          </div>
        </section>
